  ...
  return (
    <div className="h-full overflow-auto">
      <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleConfigChange('download', 'concurrent_downloads', parseInt(e.target.value))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleConfigChange('download', 'retry_attempts', parseInt(e.target.value))}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleConfigChange('download', 'timeout_seconds', parseInt(e.target.value))}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleConfigChange('ui', 'theme', e.target.value as 'light' | 'dark' | 'system')}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleConfigChange('advanced', 'log_level', e.target.value as 'error' | 'warn' | 'info' | 'debug')}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                >
        ...
        {/* 保存按钮 */}
        <div className="mt-8 flex items-center justify-between bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
